...
var TEN_TXT = {
  '比肩':{ s:'同輩、合夥、競爭', y:'找朋友幫忙、談合作、運動',        j:'獨資冒進、與人爭利' },
  '劫財':{ s:'破費、爭奪、代墊', y:'還債、繳費、處理帳務',            j:'借貸、投資、替人作保' },
  '食神':{ s:'才藝、口福、閒情', y:'寫作、教學、餐敘、休養',          j:'過勞、熬夜' },
  '傷官':{ s:'表現、鋒芒、口舌', y:'發表、提案、展現專業',            j:'頂撞上司、批評他人' },
  '偏財':{ s:'外財、應酬、機會', y:'業務、談生意、開拓客源',          j:'賭性投機、酒色財氣' },
  '正財':{ s:'正財、務實、積累', y:'收款、簽約、置產、記帳',          j:'鋪張、衝動消費' },
  '七殺':{ s:'壓力、挑戰、突發', y:'處理難題、體能訓練、果斷決策',    j:'逞強、與人衝突、開快車' },
  '正官':{ s:'名位、規矩、責任', y:'求職、面試、送件、見長官',        j:'違規、拖延公務' },
  '偏印':{ s:'偏學、獨處、思慮', y:'研究、進修、靜心、看醫生',        j:'鑽牛角尖、多疑' },
  '正印':{ s:'貴人、庇蔭、學習', y:'求教長輩、簽約用印、讀書',        j:'依賴他人、怠惰' }
};
