...
const CACHE='fsc-v35';
const CORE=['./index.html','./購買說明.html','./現場勘查.html','./lock.js','./report.js','./theme.css','./case.js','./易經推命.html','./擇日.html','./manifest.json','./icon-192.png','./icon-512.png','./場所佈局.html','./金錢卦.html','./全宅健檢.html','./陰宅水法.html','./客戶案件簿.html','./紫微斗數.html',
